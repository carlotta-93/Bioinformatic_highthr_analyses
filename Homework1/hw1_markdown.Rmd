...
hist(gene_lengths$mrna_length, col="red",xlim=c(0,1000000), ylim=c(0,10000), breaks=100, 
     main="Histogram of exon length", ylab="Frequency", 
     xlab="Length of exon", border="red")

# Intron_length histogram: 
hist(gene_lengths$intron_length,col="blue",xlim=c(0,1000000), ylim=c(0,10000),
