...
logRpkm_plot
```
The plot shows that the frequency of samples with value RPKM value equals 0 from Kallisto tool is higher than the frequency from Salmon analysis. The highest frequency is registered in the WT3 from Kallisto replicates with a value greater than 12000. In all of the replicates the frequency of the samples decreases with the increasing of the RPKM values.
